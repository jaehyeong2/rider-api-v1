package jjfactory.simpleapi.domain.rider.domain;


import jjfactory.simpleapi.domain.rider.dto.req.RiderCreate;
import jjfactory.simpleapi.domain.seller.domain.Seller;
